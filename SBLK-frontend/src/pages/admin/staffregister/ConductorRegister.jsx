...
const ConductorRegister = () => {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:8080/api/staff/register?role=CONDUCTOR', {
        method: 'POST',
        headers: {
      ...
      alert('Error registering conductor: ' + error.message);
    } finally {
      setLoading(false);
    }
  };
