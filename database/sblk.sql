...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 25, 2025 at 08:40 AM
...
CREATE TABLE `staff` (
  ...
  `gender` varchar(255) DEFAULT NULL,
  `license_copy_path` varchar(255) DEFAULT NULL,
  `mobile_number` varchar(255) DEFAULT NULL,
  `nic` varchar(255) DEFAULT NULL,
  `previous_employment_details` varchar(2000) DEFAULT NULL,
  `registered_depot` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `staff` (`id`, `first_name`, `last_name`, `email`, `mobile`, `address`, `role`, `username`, `password`, `created_at`, `department`, `license_number`, `vehicle_assigned`, `address_line1`, `address_line2`, `city`, `date_of_birth`, `district`, `driver_license_expiry_date`, `driver_license_number`, `experience_years`, `gender`, `license_copy_path`, `mobile_number`, `nic`, `previous_employment_details`, `registered_depot`) VALUES
(12, 'Ramesh', 'Silva', 'dasulinavodya@gmail.com', NULL, NULL, 'DRIVER', 'rsilva515', '$2a$10$AYV.bgOf9TAeCqkZ8WWuAu34QTloyIPFubkA88OVrT3zDYBXJh0Zu', '2025-10-20 11:22:13', NULL, NULL, NULL, 'No.12, Depot Lane', 'Galle', 'Galle', '1980-08-22', 'Galle', '2030-12-31', 'B1234567', 8, 'Male', NULL, '0769876543', '802221111V', 'Worked as intercity driver', NULL),
(14, 'Venurs', 'Silva', 'sen@gmail.com', NULL, NULL, 'CONDUCTOR', 'vsilva235', '$2a$10$8Y5XSSS4BNnh5rpnS5Xy2OALSPl59tjTwBjCDfinZwCQIqh14fCFG', '2025-10-23 01:36:11', NULL, NULL, NULL, 'No.12, Depot Lane', 'Galle', 'Galle', '1980-08-22', 'Galle', '2030-12-31', 'B1234567', 8, 'Male', NULL, '0765876543', '802221111V', 'Worked as intercity driver', NULL);
